  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/10 bg-cream/90 backdrop-blur-xl">
      <div className="section-shell flex min-h-20 items-center justify-between gap-4 py-3">
        ...
        <nav className="hidden items-center gap-3 text-xs font-semibold text-ink/75 lg:flex xl:gap-4" aria-label="Menu principal">
          {navItems.map((item) => (
            <a
        ...
        <ButtonLink href={contact.whatsapp} icon={MessageCircle} className="hidden xl:inline-flex">
