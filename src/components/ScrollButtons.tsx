...
export function ScrollButtons({ targetId, label }: ScrollButtonsProps) {
  ...
  return (
    <>
      <button
        className="focus-ring absolute -left-3 top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-lg bg-ink text-white shadow-soft transition hover:-translate-y-[calc(50%+2px)] hover:bg-black sm:flex"
        type="button"
        onClick={() => scroll("left")}
      ...
      <button
        className="focus-ring absolute -right-3 top-1/2 hidden h-12 w-12 -translate-y-1/2 items-center justify-center rounded-lg bg-sunshine-400 text-ink shadow-glow transition hover:-translate-y-[calc(50%+2px)] hover:bg-sunshine-300 sm:flex"
        type="button"
